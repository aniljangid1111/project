...
export default function AdminListing() {
    ...
    const openEdit = () => setShowInput(!ShowInput);
        ...
        <div className="p-6 bg-gray-100 min-h-screen">
            ...
            <div className='flex justify-between items-center px-4'>
                <div className="mb-4">
                    ...
                    <p className="text-blue-600 text-sm"><Link to='/'>Dashboard</Link> / Admins</p>
                </div>
                ...
                <div className="mb-2 flex gap-3 items-center justify-center text-center">
                    ...
                    <button
                        onClick={openEdit}
                        className=" text-white flex justify-center text-center  text-[30px]  rounded-[50%] w-10 h-10 bg-blue-600  items-center  hover:bg-blue-700 transition-all   "
                    >
                        +
                    </button>
                </div>
            ...
            {/* Edit Panel */}
            <div
                className={`transition-all duration-500 overflow-hidden ${ShowInput ? 'max-h-[1000px] mb-4' : 'max-h-0'}`}
            >
