...
exports.create = async (request, response) => {
    ...
    var data = new country(saveData);
    await data.save()
        .then((result) => {
            const output = {
                _status: true,
                _message: 'Country Recorde Inseted !!',
                _data: result
            }
...
exports.view = async (request, response) => {
    ...
    var totalrecords = await country.find(filter).countDocuments();

    await country.find(filter).sort({
        order: 'asc'
    })
...
exports.details = async (request, response) => {
    ...
    await country.findById(request.params.id)
        .then((result) => {
            if (result) {
                const output = {
                    _status: true,
