...
const { create, view, details, update, changestatuse, destroy } = require('../../controller/admin/subCategory.controller.js');
const router = express.Router();
const multer = require('multer')
const uploads = multer({ dest: 'uploads/subCategories' })
...
module.exports = server => {
    ...
    server.use('/api/admin/subCategory', router)
}
