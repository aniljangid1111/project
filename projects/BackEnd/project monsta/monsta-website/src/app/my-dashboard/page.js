...
export default function DashboardPage() {
    ...
    const changePassword = (event) => {
        ...
        axios.post('http://localhost:8001/api/website/users/change-password', event.target, {
            headers: {
                'Authorization': `Bearer ${userToken}`
            }
        })
                                            ...
                                            <div className="account_login_form">
                                                <form onSubmit={changePassword}>
                                                    ...
                                                    <div className="form-group has-feedback">
                                                        ...
                                                        <input type="password" className="form-control" id="confirmPassword" name="confirm_password" data-bv-field="confirmPassword" />
                                                    </div>

                                                    <br />
                                                    <div className="login_submit">
                                                        <button type="submit" className="common_btn text-uppercase" title="Update">Change Password</button>
                                                    </div>
