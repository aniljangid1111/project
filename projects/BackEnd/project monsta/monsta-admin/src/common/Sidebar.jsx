...
import logo from '/monstalogo.png'
export default function Sidebar() {
  ...
  return (
    <>
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 w-[272px] h-screen transition-transform -translate-x-full sm:translate-x-0   "
        aria-label="Sidebar"
      >
        <div className="h-full   overflow-y-auto bg-gray-50 dark:bg-gray-800 scrollbar-hide">
          <Link to={"/dashboard"}>
            <div className='bg-[#3E8EF7] h-[65px] py-2  m-0 p-0  '>
