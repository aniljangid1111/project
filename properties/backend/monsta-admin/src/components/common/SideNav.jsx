          ...
          <div class="h-full   bg-gray-50 dark:bg-gray-800">
            <div className='bg-[#3E8EF7] h-[65px] py-2 w-full m-0 p-0  '>
              <figure className=' w-[130px] ms-6 relative'>
                <img src='../../../public/monstalogo.png' alt="" className='w-[100%]' />
              </figure>
            ...
            <ul class="space-y-2 px-3 py-4  text-[14px]">
              ...
              <li >
                ...
                <ul id="colors-drop" class="hidden py-2 space-y-2">
                  <li>
                    <Link to="color/view" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View Color</Link>
                  </li>
                  <li>
                    <Link to="color/add" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add Color</Link>
                  </li>
                </ul>
              </li>
              <li >
                ...
                <ul id="materials-drop" class="hidden py-2 space-y-2">
                  <li>
                    <Link to="material/view" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View Material</Link>
                  </li>
                  <li>
                    <Link to="material/add" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add Material</Link>
                  </li>
                </ul>
              </li>
              {/* Parent category */}
              <li >
                ...
                <ul id="parentCategory-drop" class="hidden py-2 space-y-2">
                  <li>
                    <Link to="category/view" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View Category</Link>
                  </li>
                  <li>
                    <Link to="category/add" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add Category</Link>
                  </li>
                </ul>
              </li>
              {/* Sub Categories */}
              <li >
                ...
                <ul id="subCategory-drop" class="hidden py-2 space-y-2">
                  <li>
                    <Link to="category/sub-category/view" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View Category</Link>
                  </li>
                  <li>
                    <Link to="category/sub-category/add" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add Category</Link>
                  </li>
                </ul>
              </li>
              {/* Sub Sub category */}
              <li >
                ...
                <ul id="subSubCategory-drop" class="hidden py-2 space-y-2">
                  <li>
                    <Link to="category/sub-sub-category/view" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View Category</Link>
                  </li>
                  <li>
                    <Link to="category/sub-sub-category/add" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add Category</Link>
                  </li>
                </ul>
              </li>
              {/* Product  */}
              <li >
                ...
                <ul id="product-drop" class="hidden py-2 space-y-2">
                  <li>
                    <Link to="product/view" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View Product</Link>
                  </li>
                  <li>
                    <Link to="product/add" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add Product</Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul id="dropdown-location" class="hidden py-2 space-y-2">
                  <li>
                    <Link to="country/add" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add Countrie</Link>
                  </li>
                  <li>
                    <Link to="country/view" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View Countrie</Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul id="Enquirys" class="hidden py-2 space-y-2">
                  <li>
                    <Link to="/enquiry" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Contact Enquirys</Link>
                  </li>
                  <li>
                    <Link to="/newsletter" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Newssletters</Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul id="dropdown-Faqs" class="hidden py-2 space-y-2">
                  <li>
                    <Link to="/faq/add" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add Faqs</Link>
                  </li>
                  <li>
                    <Link to="/faq/view" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View Faqs</Link>
                  </li>
                </ul>
              </li>
