...
export default function ViewCategory() {
  ...
  let allSelecteBox = () => {
    if (checkBox.length != categories.length) {
      let data = [];
  ...
  let deleteSelect = () => {
    ...
    if (confirm("Are you want to delete ")) {
      axios
        .post(
          "http://localhost:8400/api/admin/category/delete",
  ...
  let changestatus = () => {
    // console.log(checkBox);
    axios
      .post('http://localhost:8400/api/admin/category/change-status',toFormData({ id: checkBox })
      )
      .then((success) => {
        if (success.data.status == true) {
          setCurrentPage(1);
                  ...
                  <tr>
                    ...
                    >
                      <input
                        ...
                        value=""
                        checked={
                          checkBox.length == categories.length ? true : ""
                        }
                    ...
                    <th scope="col" className="px-6 py-3" width="200px">
                      S. No.
                    </th>
                      ...
                      return (
                        <tr className="bg-white border-b">
                          ...
                          <td className="px-6 py-4 flex gap-3 mt-6">
                            ...
                            <Link
                              to={`/parent-category/update-category/${v._id}`}
                            >
                              <svg
                                fill="gold"
                                className="w-4 h-4"
